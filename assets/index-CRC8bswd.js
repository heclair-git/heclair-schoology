    ...
    <div class="app-container">
      ...
      <header class="app-header">
        <div>
          ...
          <p class="brand-subtitle" id="school-subtitle">${e.meta.school} • Dynamic Server Sync</p>
        </div>
